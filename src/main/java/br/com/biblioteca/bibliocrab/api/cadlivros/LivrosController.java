...
import br.com.biblioteca.bibliocrab.modelo.cadlivros.LivrosService;
...
public class LivrosController {
   ...
   public Iterable<Livros> listarTodos() {
    ...
    @PostMapping
    public Livros cadastrar(@RequestBody Livros livros){
    return livrosService.save(livros);
  }
  
   @GetMapping("/{id}")
   public Livros obterPorID(@PathVariable Long id) {

       return livrosService.obterPorID(id);
   }
